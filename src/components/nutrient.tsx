...
export const Nutrient: React.FC = () => {
  ...
  const [activePracticeTab, setActivePracticeTab] = useState<FarmingMode>(profile.farmingPractice);

  const landArea = profile.totalLandArea; // in hectares

  // Helper to convert kg/ha rate to total kg needed for current land area
  const getWeightRequired = (kgPerHaRate: number) => {
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-slate-900/40 border border-emerald-950/30 p-6 rounded-3xl flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex bg-slate-950 p-1.5 rounded-2xl border border-slate-900 shrink-0">
          {(['Organic Farming', 'Integrated Nutrient Management (INM)', 'Conventional Farming'] as FarmingMode[]).map((tab) => (
            <button
              key={tab}
              onClick={() => {
      ...
      {/* Mode View Panels */}
      {activePracticeTab === 'Conventional Farming' && (
          ...
          <div className="bg-slate-900/60 border border-emerald-950/40 rounded-3xl p-6 shadow-md space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="bg-slate-950/60 p-3.5 rounded-2xl border border-slate-900">
      ...
      {activePracticeTab === 'Organic Farming' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-slate-900/60 border border-emerald-950/40 rounded-3xl p-6 shadow-md space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={idx} className="bg-slate-950/60 border border-slate-900 p-4 rounded-2xl flex justify-between items-center">
                  <div>
          ...
          <div className="bg-slate-900/60 border border-emerald-950/40 rounded-3xl p-6 shadow-md space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-3 text-xs">
              {[
                ...
                <div key={idx} className="bg-slate-950/50 p-3 rounded-2xl border border-slate-900">
      ...
      {activePracticeTab === 'Integrated Nutrient Management (INM)' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900/60 border border-emerald-950/40 rounded-3xl p-6 shadow-md space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="bg-slate-950/60 p-3.5 rounded-2xl border border-slate-900 flex justify-between items-center">
                  <div>

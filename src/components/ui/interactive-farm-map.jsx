...
export const InteractiveFarmMap = () => {
    ...
    const getSVGColor = (plotId, status) => {
    ...
    return (<div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-start">
      ...
      <div className="md:col-span-3 bg-slate-900/40 border border-emerald-950/40 rounded-2xl p-4 shadow-inner">
        ...
        <div className="relative aspect-video w-full rounded-xl overflow-hidden bg-slate-950 border border-slate-900 p-2">
          <svg viewBox="0 0 400 240" className="w-full h-full cursor-pointer select-none">
            ...
            {/* Plot 1: Top Left */}
            <rect x="15" y="15" width="170" height="95" rx="8" className={`transition-all duration-300 stroke-2 ${getSVGColor(1, plots[0].status)}`} onClick={() => setSelectedPlot(1)}/>
            ...
            {/* Plot 2: Top Right */}
            <rect x="215" y="15" width="170" height="95" rx="8" className={`transition-all duration-300 stroke-2 ${getSVGColor(2, plots[1].status)}`} onClick={() => setSelectedPlot(2)}/>
            ...
            {/* Plot 3: Bottom Left */}
            <rect x="15" y="130" width="170" height="95" rx="8" className={`transition-all duration-300 stroke-2 ${getSVGColor(3, plots[2].status)}`} onClick={() => setSelectedPlot(3)}/>
            ...
            {/* Plot 4: Bottom Right */}
            <rect x="215" y="130" width="170" height="95" rx="8" className={`transition-all duration-300 stroke-2 ${getSVGColor(4, plots[3].status)}`} onClick={() => setSelectedPlot(4)}/>
      ...
      <div className="md:col-span-2 bg-gradient-to-b from-slate-800/80 to-slate-900 border border-emerald-950/50 rounded-2xl p-5 shadow-lg h-full flex flex-col justify-between">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="h-2 w-full bg-slate-800 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-500 to-teal-400 rounded-full transition-all duration-500" style={{ width: `${activePlot.progress}%` }}/>
              </div>
            </div>
        ...
        {activePlot.status === 'Pest Alert' && (<div className="mt-4 bg-rose-950/30 border border-rose-900/40 p-3 rounded-xl flex items-start gap-2 text-rose-300">

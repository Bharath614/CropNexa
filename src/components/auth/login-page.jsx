...
export const LoginPage = ({ onLoginSubmit, onGoToRegister, currentLanguage, onLanguageChange }) => {
    const { dispatchOutboundNotification, showToast, loginWithGoogle } = useFarm();
                ...
                <div className="max-w-md w-full mx-auto space-y-7 animate-fadeIn">
                    ...
                    <div className="pt-2">
                        <button 
                            ...
                            className="w-full py-3.5 bg-slate-900 hover:bg-slate-850 border border-slate-800 hover:border-emerald-800 text-slate-200 font-extrabold rounded-2xl text-xs sm:text-sm flex items-center justify-center gap-3 transition-all cursor-pointer shadow-md hover:scale-[1.01]"
                        >

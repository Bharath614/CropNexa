    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between bg-emerald-950 text-white p-4 border-b border-emerald-800 sticky top-0 z-50">
        ...
        <button 
          ...
          className="p-2 text-emerald-400 hover:text-white transition-colors focus:outline-none cursor-pointer"
        >
      ...
      `}>
          ...
          <div className="p-3 mx-3 my-3 bg-gradient-to-br from-slate-800/90 to-slate-900 border border-emerald-950/60 rounded-2xl space-y-2">
            ...
            <div className="flex items-center justify-between pt-1 border-t border-slate-800/80 text-[10px]">
              ...
              <select
                ...
                className="bg-slate-950 text-emerald-300 font-bold px-2 py-0.5 rounded-lg border border-slate-800 focus:outline-none cursor-pointer"
              >
        ...
        <div className="p-3 border-t border-emerald-950/40 bg-slate-900/60 space-y-2">
          <button 
            onClick={logoutUser}
            className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-bold bg-rose-950/40 hover:bg-rose-900/60 text-rose-300 border border-rose-900/50 transition-all cursor-pointer"
          >

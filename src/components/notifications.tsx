...
import { useFarm, NotificationCategory } from '@/context/farm-context';
import { 
  Bell, 
  Search, 
  CheckCheck, 
...
export const NotificationsCenter: React.FC = () => {
  ...
  const getCategoryIcon = (cat: NotificationCategory | string) => {
    switch (cat) {
    ...
    <div className="space-y-6 animate-fadeIn">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-emerald-950 hover:bg-emerald-900 text-emerald-300 border border-emerald-800 rounded-2xl text-xs font-bold transition-colors cursor-pointer"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-2xl pl-10 pr-4 py-2 text-xs text-slate-200 focus:outline-none focus:border-emerald-500"
            />
          </div>
      ...
      <div className="space-y-3">
        {filteredNotifications.length === 0 ? (
          <div className="bg-slate-900/60 border border-slate-900 rounded-3xl p-12 text-center space-y-3">
              ...
              <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
                {!notif.read && (
                  <button
                    ...
                    className="p-2 bg-slate-950 hover:bg-emerald-950 text-emerald-400 rounded-xl text-xs border border-slate-800"
                    title="Mark as Read"
                  >
                ...
                <button
                  ...
                  className="p-2 bg-slate-950 hover:bg-rose-950 text-slate-500 hover:text-rose-400 rounded-xl text-xs border border-slate-800"

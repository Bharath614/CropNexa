import { SoilReportData } from './soil-evaluation';

export interface ParseResult {
  success: boolean;
  data: Partial<SoilReportData>;
 ...
 */
export async function parseSoilReportFile(file: File): Promise<ParseResult> {
  ...
  let extractedData: Partial<SoilReportData> = {};

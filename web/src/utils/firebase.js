...
// Silence verbose offline/timeout console warnings from Firestore dev mode
setLogLevel('error');
// Initialize Firestore with auto-detect long polling to avoid 10-second WebSocket timeouts
